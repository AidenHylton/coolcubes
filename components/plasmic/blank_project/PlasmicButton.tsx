...
import sty from "./PlasmicButton.module.css"; // plasmic-import: jtmOiA_dQdy/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: MIDp73janzo/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: mgp3nFPIgky/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4CcJ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__nzdaY)}
                role={"img"}
              />
            ),
